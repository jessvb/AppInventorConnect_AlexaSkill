...
const handlers = {
  ...
  'SetProjectName': function () {
    let tempProjName = this.event.request.intent.slots.projName.value;
    if (tempProjName != null) {
      // Feedback for the user:
      let voiceOutput = 'Okay, I\'ll set the project name to ' + tempProjName;
      let cardOutput = 'Project name was set to ' + tempProjName;
      // set the project name:
      projectName = tempProjName;
      ...
      console.error(
        'The dialogState is completed, but there is no project name value. Project name: ' +
        tempProjName + '. This should never occur.');
    } else {
      // There was no project name included, so get Alexa to ask the user for a name
  ...
  'SignalIntent': function () {
    if (projectName != null) {
      ...
      if (signalNum != null) {
        console.log('signalling project, ' + projectName + ' with number: ' + signalNum);
        // for lambda redis
        ...
        if (error) {
          ...
          voiceOutput = 'Successfully connected to App Inventor! Sent signal ' +
            signalNum + ' to project ' + projectName + '. ';
      ...
      // the project name isn't set. Tell the user to set the project name.
      let voiceOutput = 'Inventor Codi needs to know the project name before he can ' +
        'send a signal. Ask Inventor Codi to set the project name.';
      this.response.speak(voiceOutput);
    }
  },
